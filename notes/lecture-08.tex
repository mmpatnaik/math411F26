...
Suppose $(t_n)_{n\geq0}$ is a bounded infinite sequence of nonnegative real
numbers, and let $S$ be the set of all its accumulation points. Then
\be
...
If $(t_n)_{n\geq0}$ is an unbounded infinite sequence of nonnegative real
numbers, we set $\limsup_n t_n=\infty$.
\end{definition}
