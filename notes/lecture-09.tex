...
Let $f(z)=\sum a_nz^n$ on $D(0,r)$.

\begin{center}
\emph{Question.} What is the relation between $f'(z)$ --- the derivative we
discussed earlier --- and $\sum_{n\geq1}n\,a_nz^{n-1}$?
\end{center}
...
the real-variable setting --- think of uniform limits of polynomials
approximating $|x|$. Uniform convergence alone is therefore insufficient;
the proof below uses the power series structure.
\end{warning}
