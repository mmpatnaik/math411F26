...
The familiar exponential law continues to hold; verify it as an exercise:
\be
...
This is easy to see: consider the line $\ell_P$ through $N$ and passing through $P$. It has parametric form \be{} \ell: P + t ( P - N) =  (t x_1, tx_2, 1 + t(x_3-1)). \ee This line intersects the horizontal plane passing through the origin for \be{} 1 + t (x_3-1) =0. \ee Unravelling this, we obtain the above formula.
