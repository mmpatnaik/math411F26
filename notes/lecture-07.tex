...
Given $f_n$ a sequence of functions on $S$, what does $f_n\to f$ mean?
...
\begin{definition} Let $\{f_n\}$, a sequence of functions on $S$. We say that $\{ f_n \}$ is
\emph{uniformly Cauchy on $S$} if given $\epsilon>0$ there exists $n_0$ such that if $n,m\ge n_0$ then
\be
 \|f_n-f_m\|_S<\epsilon.
\ee
\end{definition}
